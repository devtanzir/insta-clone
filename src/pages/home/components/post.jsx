...
import Author from "../../../assets/images/BDxPEL.jpg";
import PostPhoto from "../../../assets/images/post-image.jpeg";
    ...
    <>
      <div className="p-4">
        <div className=" bg-black">
          ...
          <div className="flex items-center justify-between p-3">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center">
                <span className="font-semibold">_BanGlaDEsHi_</span>
          ...
          <img
            src={PostPhoto}
            alt="Book cover with Bengali text"
